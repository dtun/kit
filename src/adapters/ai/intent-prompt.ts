...
export function buildClassificationSystemPrompt(context: string): string {
	return [
		...
		'- calendar_view: "What\'s on the calendar?" / "Any events this week?" / "What\'s scheduled?"',
		'- calendar_add: "Add soccer practice Wednesday at 4pm" / "Put the dentist on the calendar Thursday 3pm"',
		...
		'IMPORTANT: If the user mentions a specific date + time + activity and says "add" or "put" or "schedule", that\'s calendar_add — not remember or task.',
		'IMPORTANT: If asking about "the calendar" or "scheduled" or "events", that\'s calendar_view — not status.',
		"",
		"FORWARDED EMAILS:",
